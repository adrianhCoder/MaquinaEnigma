...
def generar_rotores():
    ...
    rotor mas lento---> izquierda
     ...
     r3= izquierdo LENT0
    """
    r1 = [[16, 23, 10, 5, 4, 11, 7, 19, 9, 13, 24, 2, 0, 1, 15, 6, 18, 20, 21, 17, 25, 12, 14, 8, 22, 3,26],
          [19, 6, 18, 5, 8, 0, 23, 13, 3, 16, 10, 1, 12, 2, 17, 9, 25, 14, 7, 15, 21,26, 11, 24, 4, 20, 22]]
    r2 = [[10, 14, 23, 8, 24, 1, 0, 13, 18, 16, 15, 22, 21, 6, 9, 17, 25, 11, 19, 2, 20,26, 12, 4, 3, 7, 5],
          [13, 15, 2, 1, 22, 23, 9, 8, 18, 17, 21, 11, 16, 24, 0, 10, 19, 5, 3,26, 12, 6, 7, 14, 25, 4, 20]]
    r3 = [[25, 0, 17, 10, 1, 12, 16, 11, 15, 9, 24, 2, 18, 21, 19, 7, 5, 3, 8,26, 6, 23, 22, 13, 14, 4, 20],
          [7, 16, 1, 9, 23, 5, 8, 11, 18, 15, 21,26, 6, 22, 10, 12, 25, 0, 19, 2, 14, 20, 17, 13, 4, 24, 3]]
